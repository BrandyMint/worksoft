...
feature 'Регистрация разработчика (создание профиля)', %q{
  ...
  before do
    ...
    FactoryGirl.create(:supported_configuration)
  ...
  scenario 'Будущий разработчик создает свой профиль' do
    ...
    find(:xpath, '(//select[starts-with(@name, "bundle[supported_configurations_attributes][new_")])[1]').find(:option, 'БухгалтеряПредприятия_1').select_option
    find('.btn-primary').click
